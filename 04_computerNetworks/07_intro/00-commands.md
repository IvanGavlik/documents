...
`ip neigh show` ARP cache table 

`sudo ip neigh flush all` ARP cache table clear

TODO learn about ip command 
...
TODO learn about tools Ettercap, Arpspoof, Bettercap, Cain & Abel
