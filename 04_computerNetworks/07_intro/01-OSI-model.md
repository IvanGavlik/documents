...
| TCP                               | IP Model       | what you work with  |
| --------------------------------- | -------------- | ------------------- |
| Application, Presentation Session | Aplication     | HTTP, DNS, SSH, FTP |
| Transport                         | Transport      | TCP, UDP            |
| Network                           | Internet       | IP, ICMP, routing   |
| Data Link Physical                | Network Access | WIFI, cables        |
...
* HDLC Hight level data link contorl 

* Frame Relay

* ATM Asynchronous Transfer mode

* L2TP Layer 2 tonneling Protocol
...
* IGMP Inteernt Gropu Management Protocol
...
* BGP Routing Gateway Protocol

* EIGRP Enhanced Interior Gateway Routing Protocol

* IS-IS intermediate System to Intermdeidat System
...
* SCTP Stream Congestion Control Protocol
...
* RTCP Real-time Transpot Controll Protocol

* PAP Password Authentication Protocol

* L2TP - Layer 2 Tunneling Protocol (session)
...
* EBSDIC Extended Binary Coded Decimal Interchange Code

* MPEG Video encoding

* Encryption prorocols: 3DES, AES, RSA

**Application Layer**

* HTTP/HTPS HyperText Transfer Protocol

* FTP/FTPS File Transfer protocol

* STMP Simpe mail Transfer Protocol
...
* SNMP Simple Newtork Management Protocol
...
* IPv4 ACD Address Conflict Detection
